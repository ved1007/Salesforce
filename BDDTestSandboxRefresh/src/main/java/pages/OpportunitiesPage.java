...
public class OpportunitiesPage extends BasePageTest {
    ...
    By DealershipSearchBoxClick = By.cssSelector("*[id^='1036:'][id$='a']");
...
//	By PriceFromPopulate = By.xpath("//a[contains(text(),'6000')]");
    ...
    public void requiredFieldMessage() {
        ...
        try {
            FileUtils.copyFile(source, new File("/Users/vedant.jagani/git/Salesforce/CucumberBDDFrame/ScreenshotsFiles/ReqFields2.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public void dealershipSearchFieldclick() {
        ...
        driver.findElement(By.cssSelector("*[id^='1036:'][id$='a']")).sendKeys("CNC");
    }
