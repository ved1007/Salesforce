...
//    By ELeadCheatCheckBox = By.cssSelector("*[id^='172:'][id$='a']");
	By opportunityNameInput = By.cssSelector("*[id^='423:'][id$='a']");
	By AmountInputField = By.cssSelector("*[id^='439:'][id$='a']");
	By AccountNameSearchField1 = By.cssSelector("*[id^='508:'][id$='a']");
	By AccountNameSearchFieldPopulat = By.xpath("//div[contains(text(),'Automation2')]");

	By CloseDateClick = By.cssSelector("*[id^='584:'][id$='a']");

	By StageClick = By.cssSelector("*[data-aura-rendered-by^='714:'][data-aura-rendered-by$='a']");
	By StageValueSelected = By.xpath("//a[@title='In-Process']");

	By NicknameInputField = By.cssSelector("*[id^='764:'][id$='a']");
	By ExpirationDate1 = By.cssSelector("*[id^='882:'][id$='a']");

	By ProbabilityInputField = By.cssSelector("*[id^='935:'][id$='a']");

	By OpportunitySellingOwnerNamefield = By.cssSelector("*[id^='919:'][id$='a']");
	By DroppedDealershipfield = By.cssSelector("*[id^='993:'][id$='a']");
	By IDSCustomerNumber = By.cssSelector("*[id^='967:'][id$='a']");
	By IDSFIQuoteNumber = By.cssSelector("*[id^='1023:'][id$='a']");
	By ReviewRequestedDate = By.cssSelector("*[id^='1081:'][id$='a']");
	By ReviewRequestedDatePopulated = By.xpath("//table[@class='calGrid']//td");

	By FirstSurveyAttemptDate = By.cssSelector("*[id^='1126:'][id$='a']");
	By FirstSurveyAttemptDatePopulate = By.xpath("//table[@class='calGrid']//td");

	By WriteUpAmountInputField = By.cssSelector("*[id^='1108:'][id$='a']");
	By CountryField = By.cssSelector("*[id^='1163:'][id$='a']");
	By eLeadCreateDateClick = By.cssSelector("*[id^='1179:'][id$='a']");
	By DealershipSearchBoxClick = By.cssSelector("*[id^='1206:'][id$='a']");
	By DealershipSearchFieldPopulate = By.xpath("//div[@title='CNC CONCORD NC RVSALES']");

	By CustomerAppointmentDateAndTimeField = By.cssSelector("*[id^='1442:'][id$='a']");
	By CustomerAppointmentDateAndTimeCalender = By.xpath("//table[@class='calGrid']//td");

	By TypeDropDownFieldClick = By.cssSelector("*[aria-describedby^='1396:'][aria-describedby$='a-label']");
	By TypeDropDownFieldPopulate = By.xpath("//a[contains(text(),'New Business')]");

	By AppointmentCompletedDateField = By.cssSelector("*[id^='1594:'][id$='a']");
	By AppointmentCompletedDateFieldCalender = By.xpath("//table[@class='calGrid']//td");

	By CustomerDeliveryDateAndTimeField = By.cssSelector("*[id^='1637:'][id$='a']");
...
//    By BusinessAdjustedCreatedDateStartCalender = By.xpath("//table[@class='calGrid']//td");
	By NewUsedYearToClick = By.cssSelector("*[aria-describedby^='1954:'][aria-describedby$='a-label']");
	By NewUsedYearToPopulate = By.xpath("//a[@title='New']");
	By YearFromClick = By.cssSelector("*[aria-describedby^='1904:'][aria-describedby$='a-label']");
	By YearFromPopulate = By.xpath("//a[@title='2017']");
	By YearToClick = By.cssSelector("*[aria-describedby^='2000:'][aria-describedby$='a-label']");
	By YearToPopulate = By.xpath("//a[@title='2017']");
	By PriceToClick = By.cssSelector("*[aria-describedby^='2252:'][aria-describedby$='a-label']");
	By PriceToPopulate = By.xpath("//a[contains(text(),'4,000')]");
	By PaymentFromClick = By.cssSelector("*[aria-describedby^='2378:'][aria-describedby$='a-label']");
	By PaymentFromPopulate = By.xpath("//a[@title='75']");
	By PaymentToClick = By.cssSelector("*[aria-describedby^='2504:'][aria-describedby$='a-label']");
	By PaymentToPopulate = By.xpath("//a[@title='100']");
	By LengthFromClick = By.cssSelector("*[aria-describedby^='2630:'][aria-describedby$='a-label']");
	By LengthFromPopulate = By.xpath("//a[@title='6 ft']");
	By LengthToClick = By.cssSelector("*[aria-describedby^='2726:'][aria-describedby$='a-label']");
	By LengthToPopulate = By.xpath("//a[@title='10 ft']");
	By FloorplanStyleClick = By.cssSelector("*[aria-describedby^='2680:'][aria-describedby$='a-label']");
	By FloorplanStylePopulate = By.xpath("//a[@title='Park Model']");
	By GeniusNotes1RVAttributes = By.cssSelector("*[id^='2776:'][id$='a']");
	By NumberSlideOutsInputField = By.cssSelector("*[id^='2802:'][id$='a']");
	By Notes2MeetAndGreetInput = By.cssSelector("*[id^='2824:'][id$='a']");
	By GeniusNotes3TradeNotesInputField = By.cssSelector("*[id^='2868:'][id$='a']");
	By NumSleepsInputField = By.cssSelector("*[id^='2912:'][id$='a']");

	// By PriceFromClick =
	// By.cssSelector("*[aria-describedby^='2100:'][aria-describedby$='a-label']");
	// By PriceFromPopulate = By.xpath("//a[contains(text(),'6000')]");

	By InterestedTypeInputField = By.cssSelector("*[id^='2959:'][id$='a']");
	By InteriorColorInputField = By.cssSelector("*[id^='2975:'][id$='a']");
	By InterestedCategoryInputField = By.cssSelector("*[id^='2995:'][id$='a']");
	By ExteriorColorInputField = By.cssSelector("*[id^='3011:'][id$='a']");
	By InterestedYearInputField = By.cssSelector("*[id^='3031:'][id$='a']");
	By NumberDoorsInputField = By.cssSelector("*[id^='3047:'][id$='a']");
	By InterestedMakeInputField = By.cssSelector("*[id^='3069:'][id$='a']");
	By MileageInputField = By.cssSelector("*[id^='3085:'][id$='a']");
	By InterestedModelInputField = By.cssSelector("*[id^='3107:'][id$='a']");
	By VehicleOptionsInputField = By.cssSelector("*[id^='3123:'][id$='a']");
	By InterestedProductInput = By.cssSelector("*[id^='3143:'][id$='a']");
	By InterestLevelDropdownClick = By.cssSelector("*[aria-describedby^='3159:'][aria-describedby$='a-label']");
	By InterestLevelDropdownPopulate = By.xpath("//a[@title='Highly Interested']");
	By VehicleTrimInputField = By.cssSelector("*[id^='3209:'][id$='a']");
	By BuyingHorizonInputField = By.cssSelector("*[id^='3225:'][id$='a']");
	By VehicleEngineInputField = By.cssSelector("*[id^='3245:'][id$='a']");
	By PaymentMethodDropdownClick = By.cssSelector("*[aria-describedby^='3261:'][aria-describedby$='a-label']");
	By PaymentMethodDropdownPopulate = By.xpath("//a[@title='Finance']");
	By ChassisDropdownClick = By.cssSelector("*[aria-describedby^='3311:'][aria-describedby$='a-label']");
	By ChassisDropdownPopulate = By.xpath("//a[@title='Chevrolet Express 3500']");
	By PaymentDetailsInput = By.cssSelector("*[id^='3357:'][id$='a']");
	By TransmissionField = By.cssSelector("*[id^='3377:'][id$='a']");
	By VehiclePricingField = By.cssSelector("*[id^='3393:'][id$='a']");
	By InterestedStockField = By.cssSelector("*[id^='3413:'][id$='a']");
	By VehicleCommentsField = By.cssSelector("*[id^='3429:'][id$='a']");
	By InterestedIdField = By.cssSelector("*[id^='3449:'][id$='a']");
	By WebpageField = By.cssSelector("*[id^='3465:'][id$='a']");

	By ToyDeskDropdownClick = By.cssSelector("*[aria-describedby^='3486:'][aria-describedby$='a-label']");
	By ToyDeskDropdownPopulate = By.xpath("//a[@title='Yes']");

	By OutDoorKitchenDropdownClick = By.cssSelector("*[aria-describedby^='3552:'][aria-describedby$='a-label']");
	By OutDoorKitchenDropdownPopulate = By.xpath("//a[@title='Yes']");

	By OutdoorEntertainmentkDropdownClick = By.cssSelector("*[aria-describedby^='3618:'][aria-describedby$='a-label']");
	By OutdoorEntertainmentDropdownPopulate = By.xpath("//a[@title='No']");

	By PreviousStageDropdownClick = By.cssSelector("*[aria-describedby^='3834:'][aria-describedby$='a-label']");
	By PreviousStageDropdownPopulate = By.xpath("//a[@title='In-Process']");

	By TowVehicleYearField = By.cssSelector("*[id^='3895:'][id$='a']");
	By MaxTowingCapacityField = By.cssSelector("*[id^='3913:'][id$='a']");
	By TowVehicleMakeField = By.cssSelector("*[id^='3935:'][id$='a']");
	By TowVehicleModelField = By.cssSelector("*[id^='3969:'][id$='a']");
	By TowVehicleVINField = By.cssSelector("*[id^='3985:'][id$='a']");
	By TowVehicleTrimField = By.cssSelector("*[id^='4005:'][id$='a']");
	By TowVehicleStyleField = By.cssSelector("*[id^='4039:'][id$='a']");
	By CurrentOwnerCategoryField = By.cssSelector("*[id^='4084:'][id$='a']");
	By CurrentOwnedMileageField = By.cssSelector("*[id^='4100:'][id$='a']");
	By CurrentOwnedYearField = By.cssSelector("*[id^='4122:'][id$='a']");
	By CurrentOwnedPayoffField = By.cssSelector("*[id^='4138:'][id$='a']");
	By CurrentOwnedMakeField = By.cssSelector("*[id^='4160:'][id$='a']");
	By CurrentOwnedQuoteLowField = By.cssSelector("*[id^='4176:'][id$='a']");
	By CurrentOwnedProductField = By.cssSelector("*[id^='4198:'][id$='a']");
	By CurrentOwnedModelField = By.cssSelector("*[id^='4236:'][id$='a']");
	By CurrentOwnedQuoteHighField = By.cssSelector("*[id^='4214:'][id$='a']");
	By CurrentOwnedTrimField = By.cssSelector("*[id^='4272:'][id$='a']");
	By CurrentOwnedQuoteDetailsField = By.cssSelector("*[id^='4252:'][id$='a']");
	By CurrentOwnedCommentsField = By.cssSelector("*[id^='4288:'][id$='a']");
	By CurrentOwnedLengthField = By.cssSelector("*[id^='4308:'][id$='a']");
	By CurrentOwnedConditionField = By.cssSelector("*[id^='4324:'][id$='a']");
	By CurrentOwnedEngineField = By.cssSelector("*[id^='4344:'][id$='a']");
	By CurrentOwnedIDField = By.cssSelector("*[id^='4360:'][id$='a']");
	By CurrentOwnedOptionsField = By.cssSelector("*[id^='4380:'][id$='a']");
	// Info from Lead (To Change Contact Info, Scroll Down to Contact Roles)
	By LeadPhoneField = By.cssSelector("*[id^='4425:'][id$='a']");
	By LeadEmailField = By.cssSelector("*[id^='4441:'][id$='a']");
	By LeadMobilePhoneField = By.cssSelector("*[id^='4461:'][id$='a']");
	By LeadScoreField = By.cssSelector("*[id^='4477:'][id$='a']");
	By LeadOtherPhoneField = By.cssSelector("*[id^='4499:'][id$='a']");
	By LeadWorkPhoneField = By.cssSelector("*[id^='4555:'][id$='a']");
	By LeadMessageField = By.cssSelector("*[aria-labelledby^='label-4595:'][aria-labelledby$='a']");
	By EndVisitNotesField = By.cssSelector("*[data-aura-rendered-by^='4665:'][data-aura-rendered-by$='a']");
	By SourceField = By.cssSelector("*[id^='4702:'][id$='a']");
	By LeadSourceDropDownClick = By.cssSelector("*[aria-describedby^='4798:'][aria-describedby$='a-label']");
	By LeadSourceDropDownPopulate = By.xpath("//a[@title='Internet']");
	By FormNameField = By.cssSelector("*[id^='4844:'][id$='a']");
	By WebLeadSoureDetailDropDownClick = By.cssSelector("*[aria-describedby^='4864:'][aria-describedby$='a-label']");
...
//    By PriceDropDownPopulate = By.xpath("//a[@title='$15,000 to $30,000']");
	...
	By ClicktheSavebutton = By.cssSelector("*[data-aura-rendered-by^='9061:'][data-aura-rendered-by$='a']");
...
//    }
	...
	public void dealershipSearchFieldclick() {
		...
		driver.findElement(By.cssSelector("*[id^='1206:'][id$='a']")).sendKeys("CNC ");
	}
